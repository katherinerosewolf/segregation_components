...
intersected_tracts$buffer_10000_m$`74301`$monitor_id_overlaps
...
first need to check if tract had a buffer with ANY observations

THEN count up total observations in the TRACT

# make dataset of just those monitors . . . for each tract!

# check lit on buffers to prioritize buffers

THEN exclude

THEN pull it all back together do final analysis using final choices

```{r try for one pollutant}
