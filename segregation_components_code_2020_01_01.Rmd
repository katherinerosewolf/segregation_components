...
NOTES FOR KATIE:  CURRENT WORK TO SPEED UP THE BUFFERS IS ON LINE 5141.
...
```{r census detailed shapefile without data raw, eval=FALSE, include=FALSE}
...
```{r fix tract shapefiles to be pretty, eval=FALSE, include=FALSE}
...
```{r census cartographic boundary file without data raw, eval=FALSE, include=FALSE}
...
```{r fix census cartographic boundary files to be pretty, eval=FALSE, include=FALSE}
...
```{r make CBF-based list of tract neighbors, eval=FALSE, include=FALSE}
...
# set relation_to_geometry ("agr") attribute to "constant" and precision to 1 cm
buffers <-
  map(
    .f = function(x) {
      st_agr(x) = 
      ...
      # st_set_precision(x, precision = 100)
      return(x)
      },
    .x = buffers
  )
...
```{r faster buffclipper for debugging, eval=FALSE, include=FALSE}
...
```{r clipped 1000-meter buffers for all tracts}
...
```{r clipped 2000-meter buffers for all tractseval=FALSE, include=FALSE}
...
```{r clipped 2500-meter buffers for all tractseval=FALSE, include=FALSE}
...
```{r clipped 3000-meter buffers for all tractseval=FALSE, include=FALSE}
...
```{r clipped 4000-meter buffers for all tractseval=FALSE, include=FALSE}
...
```{r clipped 5000-meter buffers for all tractseval=FALSE, include=FALSE}
...
```{r clipped 7500-meter buffers for all tractseval=FALSE, include=FALSE}
...
```{r clipped 10000-meter buffers for all tractseval=FALSE, include=FALSE}
...
```{r apply buffintersector to 1000-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 1000-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 1000-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 1000-metereval=FALSE, include=FALSE}
...
```{r apply buffintersector to 2000-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 2000-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 2000-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 2000-metereval=FALSE, include=FALSE}
...
```{r apply buffintersector to 2500-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 2500-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 2500-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 2500-metereval=FALSE, include=FALSE}
...
```{r apply buffintersector to 3000-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 3000-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 3000-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 3000-metereval=FALSE, include=FALSE}
...
```{r apply buffintersector to 4000-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 4000-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 4000-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 4000-metereval=FALSE, include=FALSE}
...
```{r apply buffintersector to 5000-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 5000-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 5000-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 5000-metereval=FALSE, include=FALSE}
...
```{r apply buffintersector to 7500-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 7500-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 7500-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 7500-metereval=FALSE, include=FALSE}
...
```{r apply buffintersector to 10000-meter buffers using safelyeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 10000-meter buffers using possiblyeval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 10000-metereval=FALSE, include=FALSE}
...
```{r isolate error cases buffintersector 10000-metereval=FALSE, include=FALSE}
...
```{r load remaining errors 1eval=FALSE, include=FALSE}
...
```{r 2000 meters 1000 precisioneval=FALSE, include=FALSE}
...
```{r 2500 meters 1eval=FALSE, include=FALSE}
...
```{r 3000 meters the firsteval=FALSE, include=FALSE}
...
```{r 4000 meters the firsteval=FALSE, include=FALSE}
...
```{r 5000 meters the firsteval=FALSE, include=FALSE}
...
```{r 7500 meters the firsteval=FALSE, include=FALSE}
...
```{r 10000 meters the firsteval=FALSE, include=FALSE}
...
```{r load remaining errors 2eval=FALSE, include=FALSE}
...
```{r 2000 meters 1 precisioneval=FALSE, include=FALSE}
...
```{r 2500 meters 2eval=FALSE, include=FALSE}
...
```{r 3000 meters the secondeval=FALSE, include=FALSE}
...
```{r 4000 meters the secondeval=FALSE, include=FALSE}
...
```{r 5000 meterseval=FALSE, include=FALSE}
...
```{r 7500 meters the secondeval=FALSE, include=FALSE}
...
```{r 10000 meters the secondeval=FALSE, include=FALSE}
...
```{r load remaining errors 3eval=FALSE, include=FALSE}
...
```{r 4000 meters the thirdeval=FALSE, include=FALSE}
...
```{r 5000 meters the secondeval=FALSE, include=FALSE}
...
```{r 7500 meters the thirdeval=FALSE, include=FALSE}
...
```{r 10000 meters the thirdeval=FALSE, include=FALSE}
...
```{r load remaining errors 4eval=FALSE, include=FALSE}
...
```{r load remaining errors no change 5eval=FALSE, include=FALSE}
...
```{r revised buffclipper making buffers precise and valid for debuggingeval=FALSE, include=FALSE}
...
```{r revised buffclipper making buffers and tracts precise and valid for debuggingeval=FALSE, include=FALSE}
...
```{r clipped 3000-meter buffers for erroring tracts using buffclipper_precvalbuffonlyeval=FALSE, include=FALSE}
...
```{r clipped 4000-meter buffers for erroring tracts using buffclipper_precvalbuffonlyeval=FALSE, include=FALSE}
...
```{r clipped 5000-meter buffers for erroring tracts using buffclipper_precvalbuffonlyeval=FALSE, include=FALSE}
...
```{r clipped 7500-meter buffers for erroring tracts using buffclipper_precvalbuffonlyeval=FALSE, include=FALSE}
...
```{r clipped 10000-meter buffers for erroring tracts using buffclipper_precvalbuffonlyeval=FALSE, include=FALSE}
...
```{r clipped 3000-meter buffers for erroring tracts using buffclipper_precvaltractbuffeval=FALSE, include=FALSE}
...
```{r clipped 4000-meter buffers for erroring tracts using buffclipper_precvaltractbuffeval=FALSE, include=FALSE}
...
```{r clipped 5000-meter buffers for erroring tracts using buffclipper_precvaltractbuffeval=FALSE, include=FALSE}
...
```{r clipped 7500-meter buffers for erroring tracts using buffclipper_precvaltractbuffeval=FALSE, include=FALSE}
...
```{r clipped 10000-meter buffers for erroring tracts using buffclipper_precvaltractbuffeval=FALSE, include=FALSE}
...
```{r apply buffintersector to 3000-meter buffers using safely 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 3000-meter buffers using possibly 2eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 3000-meter 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 4000-meter buffers using safely 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 4000-meter buffers using possibly 2eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 4000-meter 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 5000-meter buffers using safely 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 5000-meter buffers using possibly 2eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 5000-meter 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 7500-meter buffers using safely 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 7500-meter buffers using possibly 2eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 7500-meter 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 10000-meter buffers using safely 2eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 10000-meter buffers using possibly 2eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 10000-meter 2eval=FALSE, include=FALSE}
...
```{r load remaining errors no change 6eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 3000-meter buffers using safely 3eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 3000-meter buffers using possibly 3eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 3000-meter 3eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 5000-meter buffers using safely 3eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 5000-meter buffers using possibly 3eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 5000-meter 3eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 7500-meter buffers using safely 3eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 7500-meter buffers using possibly 3eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 7500-meter 3eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 10000-meter buffers using safely 3eval=FALSE, include=FALSE}
...
```{r apply buffintersector to 10000-meter buffers using possibly 3eval=FALSE, include=FALSE}
...
```{r isolate the erroring tracts buffintersector 10000-meter 3eval=FALSE, include=FALSE}
...
```{r load remaining errors 7eval=FALSE, include=FALSE}
...
```{r load hard-core error tractseval=FALSE, include=FALSE}
...
```{r 3000-m fix the holdoutseval=FALSE, include=FALSE}
...
```{r 5000s or dieeval=FALSE, include=FALSE}
...
```{r 7500s or dieeval=FALSE, include=FALSE}
...
```{r 10000s or dieeval=FALSE, include=FALSE}
...
```{r notes on errorseval=FALSE, include=FALSE}
...
```{r noteseval=FALSE, include=FALSE}
