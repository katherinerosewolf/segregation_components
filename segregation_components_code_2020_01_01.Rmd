...
```{r create dataset of only tracts with buffers, eval=FALSE, include=FALSE}

load(file = file.path("intermediate_data", 
                      "buffers_by_tract_all_sizes.rdata"))

length(buffers_by_tract_all_sizes$buffer_1000_m)
...
head(clipped_buffers$buffer_1000_m, 200)
...
# run all tracts!
precise_intersected_tracts <- map(.f = precision_maximizer_nation,
                                  .x = erroring_tracts)
...
save(precise_intersected_tracts, 
     file = file.path("intermediate_data", "precise_intersected_tracts.rdata"))
...
# load files
intermediate_object_loader("precise_intersected_tracts", 
                           "snapped_self_intersected_tracts", 
                           "snapped_grid_intersected_tracts")

# tracts still erroring after precision setting
transpose_try <-transpose(precise_intersected_tracts$buffer_10000_m)

snapped_self_intersected_tracts$buffer_10000_m$error

snapped_grid_intersected_tracts$buffer_10000_m
...
# add column with snapping information
