...
# save result
save(buffer_tract_intersections_multipolygons, 
     file = file.path("intermediate_data", 
                      "buffer_tract_intersections_multipolygons.rdata"))
...
save(buffer_intersector_nation, 
     file = file.path("functions", 
...
precision_maximizer_tract <- 
  ...
  function(tract_of_buffers_sf){
    ...
    if(err_bool){
      ...
      return_list <- list(precision_vector[i],
                          precise_tract, 
                          intersect_precise)
...
# run all tracts!
precise_tracts <- map(.f = precision_maximizer_nation,
                      .x = erroring_tracts)
...
save(precise_tracts, 
     file = file.path("intermediate_data", "precise_tracts.rdata"))
...
save(minimally_snapped_tracts, 
     file = file.path("intermediate_data", 
                      "minimally_snapped_tracts.rdata"))
...
save("intermediate_data", "precise_results.rdata")
...
save(safely_intersected_snapped_erroring_tracts, 
     file = file.path("intermediate_data", 
                      "safely_intersected_snapped_erroring_tracts.rdata"))
...
save(tracts_erroring_post_snap_precise, 
     file = file.path("intermediate_data", 
                      "tracts_erroring_post_snap_precise.rdata"))

save(indices_tracts_erroring_post_snap_precise, 
     file = file.path("intermediate_data", 
                      "indices_tracts_erroring_post_snap_precise.rdata"))

save(post_snap_precise_error_counts, 
     file = file.path("intermediate_data", 
                      "post_snap_precise_error_counts.rdata"))
