...
```{r investigating intersected buffers, eval=FALSE, include=FALSE}
...
not_null_error_buffer_intersections <- 
  map()
  Filter(Negate(is.null), safely_intersected_buffers$buffer_10000_m$error)

length(not_null_errors)
