...
# make buffers by tract for one size
buffers_by_tract_1000_m_sf_list <- 
  map(
    .f = buffer_filter, 
    .x = buffer_tract_intersections_polygons$buffer_1000_m, 
...
clipped_buffers_1000_m <- 
  map2(
    .f = buffer_clipper_tract, 
    .x = tracts_polygon_list, 
    .y = buffers_by_tract_all_sizes$buffer_1000_m
  )
