...
# run for precise tracts
valid_successes <-
  map(.x = valid_intersected_tracts,
      .f = success_detector_for_list)

zero_buffered_successes <-
  map(.x = zero_buffered_intersected_tracts,
      .f = success_detector_for_list)
...
indices_use_from_precise <- 
  map2(.x = precision_successes, 
       .y = indices_use_from_valid_or_zero_buffered, 
       .f = setdiff)  # takes elements in the first but not in the second

# self-snap indices
indices_use_from_valid_zero_buffered_precise <- 
  map2(.x = indices_use_from_valid_or_zero_buffered, 
       .y = indices_use_from_precise, 
       .f = c)  # concatenates the lists

indices_use_from_snap_self <- 
  map2(.x = snap_to_self_successes, 
       .y = indices_use_from_valid_zero_buffered_precise, 
       .f = setdiff)  # takes elements in the first but not in the second

# snap to grid indices
indices_use_from_valid_zero_buffered_precise_self <- 
  map2(.x = indices_use_from_valid_zero_buffered_precise, 
       .y = indices_use_from_snap_self, 
       .f = c)  # concatenates the lists

indices_use_from_snap_grid <- 
  map2(.x = snap_to_grid_successes, 
       .y = indices_use_from_valid_zero_buffered_precise_self, 
       .f = setdiff)  # takes elements in the first but not in the second
