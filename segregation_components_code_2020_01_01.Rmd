...
success_detector_for_tract <- 
  function(intersect_output_tract){
    success <- 
      intersect_output_tract_list[!is.null(intersect_output_tract$result)]
    return(names(success))
  }

# success_detector_for_tract_list(snapped_grid_intersected_tracts_with_metadata$buffer_10000_m$`2906`)
...
# merge with whatnot
# tracts_to_pull_valid_successes <- 
