...
```{r use buffintersector_prec_100000_valid for 3-km buffers}
...
```{r use buffintersector_prec_100000_valid for 4-km buffers}
...
```{r use buffintersector_prec_100000_valid for 5-km buffers}
...
```{r use buffintersector_prec_100000_valid for 7.5-km buffers}
...
```{r use buffintersector_prec_100000_valid for 10-km buffers}
...
rm(buffclipper_precvaltractbuff)
invisible(gc())
