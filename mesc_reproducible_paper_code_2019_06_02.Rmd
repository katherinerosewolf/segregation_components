...
load(
  file = 
    file.path(
      "intermediate_data", 
      "error_messages_3000_m_precvaltractbuff_timestwo.rdata"  # 1
    )
)
...
load(
  file = 
    file.path(
      "intermediate_data", 
      "error_messages_5000_m_precvaltractbuff_timestwo.rdata"  # 1
    )
)
...
load(
  file = 
    file.path(
      "intermediate_data", 
      "error_messages_7500_m_precvaltractbuff_timestwo.rdata"  # 8
    )
)
...
load(
  file = 
    file.path(
      "intermediate_data", 
      "error_messages_10000_m_precvaltractbuff_timestwo.rdata"  # 21
    )
)
...
snapped_5000_to_20_m <-   # smallest resolution that worked
  st_snap_to_grid(buffer_clips_5000_hard[[1]], 20)
...
# snapped_7500_to_25_m <-   # smallest resolution that worked
#   map(
#     .f = st_snap_to_grid,
...
#     )
# 
# intersected_snapped_7500_to_25_m <- 
#   map(
#     .f = safe_buffintersector, 
#     .x = snapped_7500_to_25_m
#   ) %>% 
#   transpose()
# 
# intersected_snapped_7500_to_25_m 
