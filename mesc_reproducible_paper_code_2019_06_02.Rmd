...
```{r ruca data format, eval=FALSE, include=FALSE}
...
```{r census data format, eval=FALSE, include=FALSE}
...
```{r acs data format, eval=FALSE, include=FALSE}
...
```{r 2012 household income quantiles data format, eval=FALSE, include=FALSE}
...
```{r geography changes from 2010 to 2011, eval=FALSE, include=FALSE}
...
```{r calculate segregation index, eval=FALSE, include=FALSE}
...
```{r merge sf1, eval=FALSE, include=FALSE}
...
```{r land area to demographic tibble, eval=FALSE, include=FALSE}
...
```{r deriving demographic variables, eval=FALSE, include=FALSE}
...
```{r investigating carbon, eval=FALSE, include=FALSE}
...
```{r carbon conversions, eval=FALSE, include=FALSE}
...
```{r elemental carbon variable selection, eval=FALSE, include=FALSE}
...
```{r organic carbon variable selection, eval=FALSE, include=FALSE}
...
```{r count and type monitor locations, eval=FALSE, include=FALSE}
...
```{r count monitors by state, eval=FALSE, include=FALSE}
...
```{r make spatial files from monitor locations, eval=FALSE, include=FALSE}
...
```{r assign tracts to monitors, eval=FALSE, include=FALSE}
...
```{r buffers, eval=FALSE, include=FALSE}
...
```{r unionize buffers, eval=FALSE, include=FALSE}
...
```{r simple buffclipper for debugging, eval=FALSE, include=FALSE}
...
#   error_messages_1000_m$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_1000_m_throwing_errors$`04013109801`
# 
# buffer_fix <- 
...
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_10000_m_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
```{r 2000 meters, eval=FALSE, include=FALSE}
...
```{r 2500 meters, eval=FALSE, include=FALSE}
...
```{r load remaining errors, eval=FALSE, include=FALSE}
...
#### fix remaining tracts using st_buffer
...
one_case <- 
  buffer_clips_10000_m_val_buf_prec_erroring[[1]]

error_one_case <- 
  error_messages_10000_m_val_buf_prec_erroring[[1]]

st_is_valid(buffer_clips_10000_m_val_buf_prec_erroring[[1]])
...
#### buffintersector precision then validate sequence
...
```{r revised buffclipper making buffers precise and valid for debugging}
...
```{r revised buffclipper making buffers and tracts precise and valid for debugging}
...
##### run new buffers with buffintersector 

###### using precvalbuffonly buffers
...
```{r isolate error cases buffintersector 3000-meter}
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_3000_m_precvalbuffonly$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_3000_m_precvalbuffonly_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
```{r apply buffintersector to 4000-meter buffers using safely}
...
```{r apply buffintersector to 4000-meter buffers using possibly}
...
```{r isolate the erroring tracts buffintersector 4000-meter}
...
```{r isolate error cases buffintersector 4000-meter}
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_4000_m_precvalbuffonly$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_4000_m_precvalbuffonly_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
```{r isolate error cases buffintersector 5000-meter}
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_5000_m_precvalbuffonly$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_5000_m_precvalbuffonly_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
```{r isolate error cases buffintersector 7500-meter}
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_7500_m_precvalbuffonly$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_7500_m_precvalbuffonly_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
```{r isolate error cases buffintersector 10000-meter}
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_10000_m_precvalbuffonly$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_10000_m_precvalbuffonly_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
# do 4000-meter file
safely_intersects_4000_m_precvaltractbuff <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_4000_m_precvaltractbuff
) %>% 
  transpose()
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "safely_intersects_4000_m_precvaltractbuff.rdata"
    )
)
...
# do 4000-m file
possibly_intersects_4000_m_precvaltractbuff <- 
  map(
  .f = possibly(buffintersector, 
                otherwise = "error"), 
  .x = buffer_clips_4000_m_precvaltractbuff
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "possibly_intersects_4000_m_precvaltractbuff.rdata"
    )
)
...
# make true/false vector for tracts throwing errors
errors_4000_m_precvaltractbuff_true_false <- 
  possibly_intersects_4000_m_precvaltractbuff %>% 
  str_detect(pattern = "error")

# make list of just those tracts
errors_4000_m_precvaltractbuff <- 
  possibly_intersects_4000_m_precvaltractbuff %>% 
  subset(errors_4000_m_precvaltractbuff_true_false)
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "errors_4000_m_precvaltractbuff.rdata"
    )
)
...
# get the numbers of the tracts with errors
tract_ids_4000_m_precvaltractbuff_errors <- 
  names(errors_4000_m_precvaltractbuff)

# select the actual tracts with errors
buffer_clips_4000_m_precvaltractbuff_throwing_errors <- 
  buffer_clips_4000_m_precvaltractbuff[tract_ids_4000_m_precvaltractbuff_errors]

# select the error messages
error_messages_4000_m_precvaltractbuff <- 
  safely_intersects_4000_m_precvaltractbuff$error[tract_ids_4000_m_precvaltractbuff_errors]
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "buffer_clips_4000_m_precvaltractbuff_throwing_errors.rdata"
    )
)
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "error_messages_4000_m_precvaltractbuff.rdata"
    )
)

# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_4000_m_precvaltractbuff$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_4000_m_precvaltractbuff_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
safely_intersects_5000_m_precvaltractbuff <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_5000_m_precvaltractbuff
) %>% 
  transpose()
...
buffer_clips_5000_m_precvaltractbuff_throwing_errors <- 
  buffer_clips_5000_m_precvaltractbuff[tract_ids_5000_m_precvaltractbuff_errors]
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_5000_m_precvaltractbuff$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_5000_m_precvaltractbuff_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
safely_intersects_7500_m_precvaltractbuff <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_7500_m_precvaltractbuff
) %>% 
  transpose()
...
buffer_clips_7500_m_precvaltractbuff_throwing_errors <- 
  buffer_clips_7500_m_precvaltractbuff[tract_ids_7500_m_precvaltractbuff_errors]
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_7500_m_precvaltractbuff$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_7500_m_precvaltractbuff_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
safely_intersects_10000_m_precvaltractbuff <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_10000_m_precvaltractbuff
) %>% 
  transpose()
...
buffer_clips_10000_m_precvaltractbuff_throwing_errors <- 
  buffer_clips_10000_m_precvaltractbuff[tract_ids_10000_m_precvaltractbuff_errors]
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_10000_m_precvaltractbuff$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_10000_m_precvaltractbuff_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
safely_intersects_3000_m_precvaltractbuff_timestwo <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_3000_m_precvaltractbuff_timestwo
) %>% 
  transpose()
...
buffer_clips_3000_m_precvaltractbuff_timestwo_throwing_errors <- 
  buffer_clips_3000_m_precvaltractbuff_timestwo[tract_ids_3000_m_precvaltractbuff_timestwo_errors]
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_3000_m_precvaltractbuff_timestwo$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_3000_m_precvaltractbuff_timestwo_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
# do 4000-meter file
safely_intersects_4000_m_precvaltractbuff_timestwo <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_4000_m_precvaltractbuff_timestwo
) %>% 
  transpose()
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "safely_intersects_4000_m_precvaltractbuff_timestwo.rdata"
    )
)
...
# do 4000-m file
possibly_intersects_4000_m_precvaltractbuff_timestwo <- 
  map(
  .f = possibly(buffintersector, 
                otherwise = "error"), 
  .x = buffer_clips_4000_m_precvaltractbuff_timestwo
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "possibly_intersects_4000_m_precvaltractbuff_timestwo.rdata"
    )
)
...
# make true/false vector for tracts throwing errors
errors_4000_m_precvaltractbuff_timestwo_true_false <- 
  possibly_intersects_4000_m_precvaltractbuff_timestwo %>% 
  str_detect(pattern = "error")

# make list of just those tracts
errors_4000_m_precvaltractbuff_timestwo <- 
  possibly_intersects_4000_m_precvaltractbuff_timestwo %>% 
  subset(errors_4000_m_precvaltractbuff_timestwo_true_false)
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "errors_4000_m_precvaltractbuff_timestwo.rdata"
    )
)
...
# get the numbers of the tracts with errors
tract_ids_4000_m_precvaltractbuff_timestwo_errors <- 
  names(errors_4000_m_precvaltractbuff_timestwo)

# select the actual tracts with errors
buffer_clips_4000_m_precvaltractbuff_timestwo_throwing_errors <- 
  buffer_clips_4000_m_precvaltractbuff_timestwo[tract_ids_4000_m_precvaltractbuff_timestwo_errors]

# select the error messages
error_messages_4000_m_precvaltractbuff_timestwo <- 
  safely_intersects_4000_m_precvaltractbuff_timestwo$error[tract_ids_4000_m_precvaltractbuff_timestwo_errors]
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "buffer_clips_4000_m_precvaltractbuff_timestwo_throwing_errors.rdata"
    )
)
...
save(
  ...
  file = 
    file.path(
      "intermediate_data", 
      "error_messages_4000_m_precvaltractbuff_timestwo.rdata"
    )
)

# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_4000_m_precvaltractbuff_timestwo$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_4000_m_precvaltractbuff_timestwo_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
safely_intersects_5000_m_precvaltractbuff_timestwo <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_5000_m_precvaltractbuff_timestwo
) %>% 
  transpose()
...
buffer_clips_5000_m_precvaltractbuff_timestwo_throwing_errors <- 
  buffer_clips_5000_m_precvaltractbuff_timestwo[tract_ids_5000_m_precvaltractbuff_timestwo_errors]
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_5000_m_precvaltractbuff_timestwo$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_5000_m_precvaltractbuff_timestwo_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
safely_intersects_7500_m_precvaltractbuff_timestwo <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_7500_m_precvaltractbuff_timestwo
) %>% 
  transpose()
...
buffer_clips_7500_m_precvaltractbuff_timestwo_throwing_errors <- 
  buffer_clips_7500_m_precvaltractbuff_timestwo[tract_ids_7500_m_precvaltractbuff_timestwo_errors]
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_7500_m_precvaltractbuff_timestwo$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_7500_m_precvaltractbuff_timestwo_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
safely_intersects_10000_m_precvaltractbuff_timestwo <- 
  map(
  .f = safely(buffintersector), 
  .x = buffer_clips_10000_m_precvaltractbuff_timestwo
) %>% 
  transpose()
...
buffer_clips_10000_m_precvaltractbuff_timestwo_throwing_errors <- 
  buffer_clips_10000_m_precvaltractbuff_timestwo[tract_ids_10000_m_precvaltractbuff_timestwo_errors]
...
# # isolate one error message
# check_one_case_error_message <- 
#   error_messages_10000_m_precvaltractbuff_timestwo$`04013109801`
# 
# # isolate one tract with errors
# check_one_case <- 
#   buffer_clips_10000_m_precvaltractbuff_timestwo_throwing_errors$`04013109801`
# 
# buffer_fix <- 
#   st_buffer(check_one_case, 0)
# 
...
names(error_messages_10000_m_precvaltractbuff_timestwo)
names(error_messages_10000_m_precvaltractbuff)
names(error_messages_10000_m_precvalbuffonly)
