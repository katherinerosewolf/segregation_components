...
```{r all tract intra-tract 1000-meter buffer intersections}
...
```{r all tract intra-tract 2000-meter buffer intersections}
...
```{r all tract intra-tract 2500-meter buffer intersections}
...
```{r all tract intra-tract 3000-meter buffer intersections}
...
```{r all tract intra-tract 4000-meter buffer intersections}
...
```{r all tract intra-tract 5000-meter buffer intersections}
...
```{r all tract intra-tract 7500-meter buffer intersections}
...
```{r all tract intra-tract 10000-meter buffer intersections}
