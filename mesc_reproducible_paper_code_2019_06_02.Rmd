...
```{r clippeed 10000-meter buffers for all tracts}
...
#### make buff tract intersector function for debugging

```{r make buffer intersection function from the above single case}

buffintersectintractor <- 
...
rm(buffintersectintractor)
invisible(gc())

```


```{r load buffer clip files}
...
```{r apply buffintersectintractor}
