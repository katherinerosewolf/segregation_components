...
if(
  ...
  save(
    ...
    load(file = "list_of_pm_25_frm_tibbles.rdata")  # loads the tibbles if they don't already exist
}
...
save(
    pm_25_frm_data,  # saves the tibbles to disk to avoid doing this again
    file = file.path(
      "intermediate_data",
      "pm_25_frm_data.rdata"
      )
    )
