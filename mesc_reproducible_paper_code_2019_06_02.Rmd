...
buffers_in_tract <- 
  ...
  rowid_to_column("polygon_id")  # add row numbers to id polygons in following step
...
```{r function from the above single case}

buffintersector <- 
  function(buffers_of_one_size_sf, tract_geoid_as_character) {
    }
