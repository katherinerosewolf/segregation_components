...
if(
  ...
  save(
      pm_25_frm_tibble,  # saves the tibbles to disk to avoid doing this again
      file = file.path(
        "intermediate_data",
        "pm_25_frm_tibble.rdata"
        )
    ...
    speciation_rdata_file_name <- 
     ...
     if(
      !file.exists(  # checks if tibble already exists
       ...
       # keep only actual component measurements
       speciation_tibble_species_only <- 
         speciation_tibble %>% 
...
speciator("https://aqs.epa.gov/aqsweb/airdata/daily_SPEC_2005.zip")
...
```{r speciation individual, eval=FALSE, include=FALSE}

# link to speciation file
speciation_file_link <- 
  "https://aqs.epa.gov/aqsweb/airdata/daily_SPEC_2005.zip"
...
if(
  ...
  speciation_tibble <- read_csv(
    file.path(
      "intermediate_data",
      speciation_csv_file_name)
    )
  save(
    speciation_tibble,  # save tibble to disk
    file = file.path(
      "intermediate_data",
      speciation_rdata_file_name
      )
    ...
    load(  # loads tibble if it exists
    file.path(
      "intermediate_data",
      speciation_rdata_file_name
      )
...
```{r speciation, eval=FALSE, include=FALSE}
...
# 
# # make a list of filenames for the downloaded data using the above filenames
# list_of_speciation_zip_filenames <-  # make list of what the filenames will be
#   map_chr(speciation_files,  # witness the `map` function
#           str_extract, 
#           "daily_.+\\.zip")   # witness the regular expression!
# 
# # download the files
# map2(list_of_speciation_zip_filenames, 
#      speciation_files, 
#      file_downloader, 
#      folder_as_string = "raw_data")
# 
...
#   file.path(
#     "raw_data",
#     list_of_speciation_zip_filenames
#     ),
#   unzip,
#   exdir = "intermediate_data"
#   )
# 
# # replace ".zip" with ".csv" in list_of_speciation_zip_filenames
# list_of_speciation_csv_filenames <-
#   map(list_of_speciation_zip_filenames,
#       str_replace,
#       "zip",
#       "csv")
# 
# # make list of tibble names by removing the ".zip" extension
# list_of_speciation_tibble_names <-
#   map(list_of_speciation_zip_filenames,
#       str_replace,
#       ".zip",
#       "")
...
#     file.path(
#       "intermediate_data",
#       "list_of_speciation_tibbles.rdata"
#       )
#     )
#   ) {  # checks if tibbles already exist
#   list_of_speciation_tibbles <-  # if not reads .csv files into tibbles
#     map(
#       file.path(
#         "intermediate_data",
#         list_of_speciation_csv_filenames),
#       read_csv
#       )
#   names(list_of_speciation_tibbles) <-  # names the tibbles
#     list_of_speciation_tibble_names
#   save(
#     list_of_speciation_tibbles,  # saves the tibbles to disk to avoid doing this again
#     file = file.path(
#       "intermediate_data",
#       "list_of_speciation_tibbles.rdata"
#       )
...
# list_of_speciation_tibbles <-
#   map(list_of_speciation_tibbles,
#       column_name_fixer)
# 
# # combine air data tibbles into one big tibble
# speciation_tibble <-
#   bind_rows(list_of_speciation_tibbles)
# 
# # save all air data to disk
# save(
#     speciation_tibble,  # saves the tibbles to disk to avoid doing this again
#     file = file.path(
#       "intermediate_data",
#       "speciation_tibble.rdata"
#       )
#     )
# 
# # memory and disk clearance ----------------------------------------------------
