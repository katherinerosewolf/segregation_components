...
```{r read necessary files for all data creation}
...
save(massive_species_dataframe, 
     file="massive_species_dataframe.rdata")
...
massive_species_dataframe_states <- 
  massive_species_dataframe[,c("State.Code", 
                               "State.Name")]
...
speciation_monitor_preliminary_data_dataframe <- 
  as.data.frame(speciation_monitor_preliminary_data) #make it a df
