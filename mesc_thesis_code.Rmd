...
```{r checking minimum detection limits for sensitivity analyses}
...
save(RI_nodes_urban_tracts, 
     file="RI_nodes_urban_tracts.rdata")
...
racial_iso_region_nodes$Region <- 
  as.character(racial_iso_region_nodes$Region)

# fix DC to be in the south
racial_iso_region_nodes$Region[
  racial_iso_region_nodes$State=='District Of Columbia'] <-'South'

# fix Puerto Rico
racial_iso_region_nodes$Region[
  racial_iso_region_nodes$State=='Puerto Rico'] <- 'Other'
...
racial_iso_nodes_quantiles_by_region$OverallQuantile <- 
...
# save and load
save(racial_iso_nodes_quantiles_by_region,
     file="racial_iso_nodes_quantiles_by_region.rdata")
